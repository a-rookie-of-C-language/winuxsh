...
Winuxsh is a Windows-native, non-isolated Bash-compatible shell for humans and
agents.
...
- Keep Windows host integration in Winuxsh: cwd/env synchronization, PATH
...
- Local Bash upstream gate remains local-only and should report 86 total,
  86 passed, 0 failed for the Winuxsh binary under test.
